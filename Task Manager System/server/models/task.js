...
const validate = (data) => {
    const schema = Joi.object({
        ...
        start_date: Joi.date().raw().allow(null).label("Start date"),
        ...
        reporter_id: Joi.string().trim().allow(null).label("Reported Id"),
        assignee_id: Joi.string().trim().allow(null).label("Assignee Id"),
        estimate_hour: Joi.string().trim().allow(null).label("Estimation hour"),
        task_log_hour: Joi.string().trim().allow(null).label("Task log hour"),
